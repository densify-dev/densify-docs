---
title: "Connecting Azure to Kubex"
---
...
<ol start="1">
  ...
  <li>
    Specify a connection name to clearly identify the Azure subscription in Kubex. This name will appear in the <strong>Cloud Connections</strong> list so you can easily identify this connection.
