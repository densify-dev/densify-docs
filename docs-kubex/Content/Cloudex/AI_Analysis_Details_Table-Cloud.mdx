...
<p>If the column "K8s Node Group" is populated with a dash (-) or the column is not visible, then consider deploying the <span style={{fontWeight: "bold"}}>Densify</span> <a href="#">data forwarder</a> into this cluster to collect the required data. Contact <span style={{fontWeight: "bold"}}>support@kubex.ai</span> for details.  </p>
...
<p>Contact <span style={{fontWeight: "bold"}}>support@kubex.ai</span> to review your RI candidate policies and RI coverage assessment <span style={{fontWeight: "bold"}}>Densify</span> settings. </p>
</td>
<td style={{verticalAlign: "middle", textAlign: "left", padding: "8px", border: "1px solid #ccc"}}>
<ul>
<li>ASG, EC2, RDS</li>
...
<p>Contact <span style={{fontWeight: "bold"}}>support@kubex.ai</span> to review the setting for "AWS&nbsp;Defer Recommendations". .</p>
</td>
<td style={{verticalAlign: "middle", textAlign: "left", padding: "8px", border: "1px solid #ccc"}}>
<ul>
<li>EC2, RDS</li>
