...
<p>Contact <span style={{fontWeight: "bold"}}>support@kubex.ai</span> to review your RI candidate policies and RI coverage assessment <span style={{fontWeight: "bold"}}>Kubex</span> settings. </p>
</td>
<td style={{verticalAlign: "middle", textAlign: "left", padding: "8px", border: "1px solid #ccc"}}>
<ul>
<li>ASG, EC2, RDS</li>
