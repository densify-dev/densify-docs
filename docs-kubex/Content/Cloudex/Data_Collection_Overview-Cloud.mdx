...
You can use the existing Cloud Connection wizard in the Densify Console to create GCP connections. You can also edit and delete all cloud connection using the Cloud Connection wizard. These features will be available in Cloudex in an upcoming release.
