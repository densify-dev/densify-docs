...
You can use the Cloud Connection wizard in the classic Kubex Console UI to create GCP connections. You can also edit and delete all cloud connection using the Cloud Connection wizard. These features will be available in Cloudex in an upcoming release.
