...
<td>
The red or green icons indicate whether or not the Mutating Admission Controller has been deployed. If a container exists within the cluster called "densify-webhook", then the status is Deployed (green icon), otherwise the status is Not deployed (red icon).
</td>
</tr>
<tr>
<td>
