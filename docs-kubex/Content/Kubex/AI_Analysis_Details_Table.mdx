...
<td>
The total hours are determined by calculating the duration from the time the first container, as defined by the manifest, starts, until the point that Kubex analyzes the specified containers. Total hours continues to increment until the manifest is no longer discovered by Densify.
</td>
</tr>
<tr>
<td>
