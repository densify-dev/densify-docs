    ...
    <tbody>
        ...
        <tr>
            ...
            <td style={{ verticalAlign: 'middle' }}>
                ...
                <p>The saturation threshold value is configurable. Contact <span>support@kubex.ai</span> for details.</p>
            </td>
        </tr>
        <tr>
            <td style={{ verticalAlign: 'middle' }}>
        ...
        <tr>
            ...
            <td style={{ verticalAlign: 'middle' }}>
                ...
                <p>A value of between 1 to 1.5 is ideal. If the ratio exceeds a value of 2 the cell is shaded to clearly indicate that resource allocation should be investigated. This threshold value is configurable. Contact <span>support@kubex.ai</span> for details.</p>
            </td>
        </tr>
        <tr>
            <td style={{ verticalAlign: 'middle' }}>
        ...
        <tr>
            ...
            <td style={{ verticalAlign: 'middle' }}>
                ...
                <p>The threshold value is configurable. Contact <span>support@kubex.ai</span> for details.</p>
            </td>
        </tr>
        <tr>
            <td style={{ verticalAlign: 'middle' }}>
