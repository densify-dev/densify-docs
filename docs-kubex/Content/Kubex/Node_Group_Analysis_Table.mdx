...
<table style={{ width: '100%' }}>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style={{ verticalAlign: 'middle' }}>
                <p>The number of container manifests in the node group which have exceeded the working set memory limit, in the last day.This value is a hyperlink that takes you to the <a href="./AI_Analysis_Details_Table"><span>AI Analysis Details</span> page</a>, filtered to show the container manifests, in the selected node group.</p>
            </td>
        </tr>
        <tr>
            <td style={{ verticalAlign: 'middle' }}>
