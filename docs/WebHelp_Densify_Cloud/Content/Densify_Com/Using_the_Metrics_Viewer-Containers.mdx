...
The Kubex metrics viewer allows you to view your collected and analyzed time series data to review specific container details. You can use the metrics viewer to investigate details when deciding whether to action specific recommendations.
...
* Kubex shows the last time that the configuration changed. If the container configuration has changed 3 times during the selected period, the note shows the date of the most recent change.
