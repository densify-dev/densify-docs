...
You need to create user groups that correspond to the commonly used Kubex user groups: KUBEX\_USER, KUBEX\_USER\_ADMIN and KUBEX\_AUDIT\_ADMIN.
...
4. Repeat the process to create a group for KUBEX\_USER\_ADMIN and for KUBEX\_AUDIT\_ADMIN.
...
* SaaS\_User--Users with this role can access all features in the Kubex Console.
* SaaS\_User\_Admin--Users with this role can add, edit and remove Kubex user accounts through the user management dialog box.
<Note>
