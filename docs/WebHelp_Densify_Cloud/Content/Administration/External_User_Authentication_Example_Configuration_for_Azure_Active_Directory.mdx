---
title: "External User Authentication for Microsft Entra ID"
sidebarTitle: "Microsoft Entra ID"
---

You can use the following process to setup Microsft Entra ID (formerly know as Azure AD). You need to register Kubex as a web application in your Microsoft Entra ID and then provide the following information to Kubex:
...
You must have permission to manage applications in Microsft Entra ID. i.e. Application administrator or Application developer, etc.

1. In the Microsft Entra ID portal. If you have access to multiple tenants, use the Directories + subscriptions filter in the top menu to switch to the tenant in which you want to register the application.
2. Navigate to Microsft Entra ID > App Registrations > New registration.
...
1. In the Microsft Entra ID portal, navigate to Microsft Entra ID > App Registrations.
...
1. In the Microsft Entra ID portal, in App registrations, select your application registration.
...
1. In the Microsft Entra ID portal, select App registrations and then select your application registration.
