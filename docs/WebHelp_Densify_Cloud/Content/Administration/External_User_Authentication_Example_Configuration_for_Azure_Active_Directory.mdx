...
You can use the following process to setup Microsoft Entra ID (formerly know as Azure AD). You need to register Kubex as a web application in your Microsoft Entra ID and then provide the following information to Kubex:
