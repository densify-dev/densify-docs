...
You can use the following process to setup Azure Active Directory (AD). You need to register Kubex as a web application in your Azure AD and then provide the following information to Densify:

* Application (client) ID
* Directory (tenant) ID
* Client secret (password)

An auto-provisioning feature allows users to access the Kubex Console without needing to manually create user accounts in Densify. Additional configuration is required as outlined in, [Creating User Groups for Users](#Create_groups). Contact [support@kubex.ai](mailto:support@kubex.ai) to enable the auto-provisioning feature.
...
The auto-provisioning feature allows users to access the Kubex Console without needing to manually create user accounts in Densify. Once the feature is enabled, you must create groups in your Azure AD, that correspond to Densify's user groups and add users to grant the required permissions.

Contact [support@kubex.ai](mailto:support@kubex.ai) to enable the auto-provisioning feature.

You need to create user groups that correspond to the commonly used Kubex user groups: DENSIFY\_USER, DENSIFY\_USER\_ADMIN and DENSIFY\_AUDIT\_ADMIN.
...
These settings are all configured for you by Densify. Contact [support@kubex.ai](mailto:support@kubex.ai) for details.
