---
title: "External User Authentication for Azure Active Directory"
sidebarTitle: "Azure Active Directory"
---

You can use the following process to setup Azure Active Directory (AD). You need to register Kubex as a web application in your Azure AD and then provide the following information to Kubex:
