...
The auto-provisioning feature allows users to access the Kubex Console without needing to manually create user accounts in Kubex. Once the feature is enabled, you must create groups in your Azure AD, that correspond to Kubex's user groups and add users to grant the required permissions.
