...
This topic shows you how to configure the data forwarder to connect to Prometheus or another observability platform that supports the Prometheus API with HTTP basic authentication (e,g, Grafana Cloud) and sends container data from multiple clusters to Kubex on an hourly basis.
...
<td class="td_3">
<p class="CiRBATableText">Specify the protocol to be used to connect to the Kubex REST API interface. Select http or https.</p>
</td>
<td class="td_3">
