...
The following procedure allows you to use a federated Microsoft Entra ID account to create a cloud connection to Densify. In this case a Service Principal is required to connect Kubex to your Azure subscriptions.
