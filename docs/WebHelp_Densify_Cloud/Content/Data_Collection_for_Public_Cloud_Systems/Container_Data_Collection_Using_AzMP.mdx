...
One limitation is that the default AKS monitoring stack does not collect all of the metrics required by Kubex for its analysis. A script, setup-azmp-aks-cluster.sh is provided to address this issue.
...
<td class="td_2">
<p class="CiRBATableText">The retry settings are optional and if not set specifically, then the default values are used. See <a class="RefToBookmarkNoPage MCXref xref xrefRefToBookmarkNoPage"><u>Configuring  Retry Connection Attempts</u></a> for setting details.</p>
</td>
<td class="td_2">
<p class="CiRBATableColumnText">Value</p>
</td>
</tr>
<p class="CiRBATableText">If you need to configure data collection through a proxy server, see <a class="RefToBookmarkNoPage MCXref xref xrefRefToBookmarkNoPage"><u>Configuring  a Proxy Host</u></a>.</p>
<tr>
...
<td class="td_3">
<p class="CiRBATableText">Specify the protocol  to be used to connect to the Kubex REST API interface. Select <code>http</code> or <code>https</code>.</p>
</td>
<td class="td_3">
...
<p class="CiRBATableText">This user will be authenticated by the Kubex server. </p>
</td>
<td class="td_3">
...
<p class="CiRBATableText">If  you want to specify a node group label that is not included in the following list, uncomment this parameter and specify your node group label. See <a class="RefToBookmarkNoPage MCXref xref xrefRefToBookmarkNoPage"><u>Configuring Node Group Collection</u></a> for more details.</p>
</td>
<td class="td_3">
<p> </p>
</td>
