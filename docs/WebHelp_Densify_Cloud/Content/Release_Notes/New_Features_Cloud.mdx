...
- [Kubex](#Kubex) -- Features in the latest release.
- [Container Data Forwarder](#Container_Data_Forwarder) -- Updates to Kubex's Container data collection module.
- [Kubex Automation Controller](#Kubex_Automation_Controller) -- Updates to Kubex's Automation Controller module.
...
<Accordion title="3.6.0 October 1, 2025">
  ...
  <Accordion title="Administration">
    ...
    - **Password Reset**--Password reset emails now link to Kubex instead of Densify Console.
  </Accordion>
</Accordion>  
...
<Accordion title="3.2.0 June 11, 2025">
  ...
  <Accordion title="Cloudex Updates">
    ...
    - **Timezone**--The X-axis label has been updated to indicate the timezone designation for all historical utilization charts to ‘UTC ’ This change to does not currently apply to the ML charts. The ML charts on the Cloudex Analysis Details page use Densify server's time. So this will be either “Eastern Time” or “Central Europe Time”.
...
<Accordion title="1.0.5 - November 28, 2025">
...
<Accordion title="1.0.2 - October 21, 2025">
...
<Accordion title="1.0.0 - June 25, 2025">
