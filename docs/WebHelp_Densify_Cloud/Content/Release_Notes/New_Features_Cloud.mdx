...
- Kubex--Features in the latest release.
- [Container Data Forwarder](#Forwarder)--Updates to Kubex's Container data collection module.
...
<Accordion title="3.3.0 June 25, 2025">
  <Accordion title="Kubex Updates">
    ...
    - **Performance Improvements**-- The Kubex/Cloudex UI no longer retrieves data from the Kubex Reporting Database (RDB). All Kubex and Cloudex UI component queries are directed exclusively to Kubex-specific tables in MS SQL.
...
<Accordion title="3.2.0 June 11, 2025">
  ...
  <Accordion title="Cloudex Updates">
    ...
    - **Timezone**--The X-axis label has been updated to indicate the timezone designation for all historical utilization charts to ‘UTC ’ This change to does not currently apply to the ML charts. The ML charts on the Cloudex Analysis Details page use Kubex server's time. So this will be either “Eastern Time” or “Central Europe Time”.
...
<Accordion title="3.0.0 April 23, 2025">
  <Accordion title="New Public Cloud Management Console">
    ...
    <div style={{ width:"70%" }}>
    <p>
    In this release Kubex introduces Cloudex. In this new console, Densify’s patented analytics determine optimal resource settings for your public cloud environments and display the results in a new user interface.
    ...
    Use your existing Kubex credentials to access the Cloudex console. You can either close the browser window or navigate back to the Kubex Console to log out.
