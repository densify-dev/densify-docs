...
<Accordion title="4.2.0 March 10, 2026">
    ...
    - **Kubernetes Dashboard**
      ...
      - A feature flag allows users to choose whether the classic interface or the new composable dashboard is used as their default landing page.
