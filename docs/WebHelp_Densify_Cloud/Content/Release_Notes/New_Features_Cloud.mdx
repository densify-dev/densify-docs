...
<Accordion title="3.0.0 April 23, 2025">
  <Accordion title="New Public Cloud Management Console">
    ...
    <div style={{ width:"70%" }}>
    <p>
    In this release Kubex introduces Public Cloud optimization features. In this new console, Densify’s patented analytics determine optimal resource settings for your public cloud environments and display the results in a new user interface.
