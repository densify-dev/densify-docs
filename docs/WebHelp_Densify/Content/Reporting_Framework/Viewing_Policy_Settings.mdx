...
The Optimization Policies tab provides a summary of the policy settings applied to your cloud environments. You cannot edit policy settings from this tab. Contact support@kubex.ai for more information on customizing your policy settings.
