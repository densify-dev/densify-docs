...
The optimized stacking ratio is based on the Kubex analysis. It is calculated by dividing the number of average-sized VMs that can run on these same servers, based on your operational policy, by the number of servers.
