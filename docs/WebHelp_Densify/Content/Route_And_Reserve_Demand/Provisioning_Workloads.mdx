...
However, for bookings routed to external hosting venues that are not audited, you need to manually mark the booking as Completed. Contact [support@kubex.ai](mailto:support@kubex.ai) to do this.
