...
The Route and Reserve Demand page uses the time zone of the Kubex server to filter the list of bookings displayed, and then to evaluate and route booking requests. All dates are shown and stored based on the server’s time zone, including the timeline and planned dates of booking requests.
