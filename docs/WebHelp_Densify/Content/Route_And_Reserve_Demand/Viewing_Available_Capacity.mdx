...
<Note>
Capacity unit values are saved as a user preference in the Kubex database and are used until new values are saved.
</Note>
...
* API--Contact [support@kubex.ai](mailto:support@kubex.ai) to ensure this setting is consistently defined.
