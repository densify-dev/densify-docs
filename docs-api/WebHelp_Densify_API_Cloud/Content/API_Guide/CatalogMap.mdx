---
title: "Catalog Map Compatible Instances"
---
...
Optional parameters:
1. spend tolerance: specified in terms of a multiplier. E.g., 1.3 means all compatible instance types that are less that 1.3 times
...
2. effort tolerance: only return compatible instance types that are at the provided effort level or lower. Possible values are 'none','low','medium','high' 
