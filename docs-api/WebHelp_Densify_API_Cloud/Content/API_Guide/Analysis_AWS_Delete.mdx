...
<CardGroup cols={2}>
    <Card title="Delete Aws Analysis" href="/docs-api/WebHelp_Densify_API_Cloud/Content/API_Guide/Analysis_AWS_Delete/deleteAwsAnalysis" arrow/>
</CardGroup>