...
The `/analysis/cloud/aws/<analysisId>/results` resource is used to return a collection of AWS system (i.e. EC2 instance, Auto Scaling group, etc.) recommendations for an AWS account defined by a Kubex Analysis entity (see [Analysis: Entity](./Analysis_Entity)).
