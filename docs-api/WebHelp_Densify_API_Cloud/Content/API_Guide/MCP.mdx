...
authorized users within your organization can connect to it using their Kubex credentials. 
...
Clicking ”Connect” will redirect to your authentication portal (whether through Kubex or a third-party OIDC provider), and then prompt you to authorize Claude to access your Kubex data: 
...
After adding the MCP server information, you will be prompted to authorize the tool using your Kubex credentials.
