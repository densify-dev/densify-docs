...
company’s Kubex dashboard address. For example, if your Kubex dashboard is located at https://corp.kubex.ai, 
your MCP server will be available at https://corp-mcp.kubex.ai. 
