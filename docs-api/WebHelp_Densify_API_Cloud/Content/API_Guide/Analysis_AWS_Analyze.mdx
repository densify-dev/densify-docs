...
<Note>
Collection of historical data can take a significant amount of time, depending on the number of instances from which Densifyis collecting data. Contact [support@kubex.ai](mailto:support@kubex.ai) to enable historical data collection and details of the performance impact.
</Note>
