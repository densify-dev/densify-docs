...
A Catalog Specification represents a pre-configured specification for a new guest or host. All Catalog Specifications shipped with Kubex are defined with a medium utilization Workload Profile and one disk definition.
